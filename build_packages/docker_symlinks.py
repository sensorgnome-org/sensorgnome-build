...
if __name__ == "__main__":
    ...
    include_symlinks = ["vamp-hostsdk/", "vamp-sdk/", "vamp/", "alsa/", "boost/", "fftw3.h", "sqlite3.h", "vamp/vamp.h", "zlib.h", "openssl/"]
    ...
    _ = subprocess.Popen(["ln", "-s", f"/usr/include/arm-linux-gnueabihf/openssl/opensslconf.h", f"{include_symlink_dest}openssl/opensslconf.h"])
