...
def build(temp_dir, build_output_dir, version, compiler=None, strip_bin="strip", host=''):
    ...
    configure_flags = ''
    if host == "armv7-unknown-linux-gnueabihf":
        configure_flags = "LIBUSB_CFLAGS=-I/usr/xcc/armv7-unknown-linux-gnueabihf/armv7-unknown-linux-gnueabihf/sysroot/usr/include/libusb-1.0 LIBUSB_LIBS=-L/usr/xcc/armv7-unknown-linux-gnueabihf/armv7-unknown-linux-gnueabihf/sysroot/usr/lib/ LDFLAGS=-lusb-1.0"
